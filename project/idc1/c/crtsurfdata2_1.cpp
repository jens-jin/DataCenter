...
int main(int argc,char *argv[]){
  ...
  if(argc!=4)
  {
     ...
     printf("Example:/project/idc1/bin/crtsurfdata2_1 /project/idc1/ini/stcode.ini /tmp/surfdata /log/idc/crtsurfdata2_1.log\n");
...
bool LoadSTCode(const char *inifile){
  ...
  while(true)
  {
    ...
    if(File.Fgets(strBuffer,300,true)==false){printf("File.Fgets() failed\n"); break;}
    logfile.Write("=%s=\n",strBuffer);
