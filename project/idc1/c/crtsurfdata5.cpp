/*
 * 程序名：srtsurfdata5.cpp 生成观测的分钟数据
 * 作者:jens
 */
...
int main(int argc,char *argv[]){
  ...
  if(argc!=5)
  {
     ...
     printf("Example:/project/idc1/bin/crtsurfdata5 /project/idc1/ini/stcode.ini /tmp/surfdata /log/idc/crtsurfdata5.log xml,json,csv\n");
  ...
  logfile.Write("srtsurfdata5 start running.\n");
  ...
  */
  ...
  logfile.WriteEx("srtsurfdata5 end running.\n");
